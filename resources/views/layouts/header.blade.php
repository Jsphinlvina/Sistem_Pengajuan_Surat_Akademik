  ...
  <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
    <div
      ...
      <a href="index.html" class="lg:hidden">
        <img class="dark:hidden" src="{{ asset('image/logo.webp') }}" alt="Logo" width="200" />
      </a>
...
{{--            </span>--}}
                ...
                @forelse($unreadNotifications as $notification)
                    <li>
                        <a href="{{ route('notifications.read', $notification->id) }}"
                           class="flex gap-3 rounded-lg border-b border-gray-100 p-3 hover:bg-gray-100
                            ...
                            <span class="block">
                                ...
                                <span class="text-theme-xs flex items-center gap-2 text-gray-400">
      ...
      <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
        <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
          ...
          <span class="text-theme-sm mr-1 block font-medium capitalize">
              {{ auth()->user()->name }}
          </span>
