...
$isPengajuanProsesStaffActive = request()->routeIs('pengajuan.proses.pengajuan');
...
$isDataPengajuanActive = $isPengajuanActive || $isPengajuanHistoryActive || $isPengajuanHistoryStaffActive || $isPengajuanProsesStaffActive;
          ...
          <li>
            ...
            <div class="translate transform overflow-hidden"
              ...
              <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                <li>
                  <a href="{{ route('pengajuan.proses.pengajuan') }}"
                    class="menu-item group {{ $isPengajuanProsesStaffActive ? 'menu-item-active' : 'menu-item-inactive' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                      stroke="currentColor" class="size-6">
                      <path stroke-linecap="round" stroke-linejoin="round"
