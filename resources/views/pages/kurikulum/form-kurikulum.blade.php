    ...
    <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800 px-10">
        <form action="{{
            ...
            <div class="mt-10">
                ...
                <x-comfirm-delete :action="route('kurikulum.destroy', $kurikulum->id)"
                    message="Yakin ingin menghapus Kurikulum ini?">
                    <x-slot:trigger>
                        <a
            ...
            <tr class="odd:bg-gray-100">
                ...
                <td class="px-5 py-4 sm:px-6">
                    <div class="flex items-center">
                        ...
                        <x-comfirm-delete :action="route('mata-kuliah.destroy', $mataKuliah->id)"
