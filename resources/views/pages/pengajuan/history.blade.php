...
<x-table>
   ...
   <x-slot:head>
      <tr class="border-b border-gray-100 dark:border-gray-800">
         @foreach(['No', 'Periode Semester','Nama', 'Pengajuan Surat',' Tanggal Pengajuan', 'Status', 'Action'] as $column)
         ...
         <td class="px-5 py-4 sm:px-6">
            ...
            <div class="flex items-center">
               ...
               <x-comfirm-delete :action="route('pengajuan.destroy', $pengajuan->id)"
                  message="Yakin ingin membatalkan Pengajuan ini?" title="Batalkan Pengajuan">
                  <x-slot:trigger>
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
             ...
             @elseif($pengajuan->status === 2)
                <a href="{{ route('pengajuan.download', $pengajuan->id) }}">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="17" height="17" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="stroke-gray-500">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
                    </svg>
               </a>
            @else
            <a href="{{ route('pengajuan.detail', $pengajuan) }}">
