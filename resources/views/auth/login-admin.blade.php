    ...
    <div>
      <div class="mb-5 sm:mb-8">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">
          Masukkan Kode User dan Password untuk Login!
        </p>
      </div>
      <div>
          ...
          <div class="space-y-5">
            ...
            <div>
              <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                Kode User<span class="text-error-500">*</span>
              </label>
              <input type="text" id="kode" name="kode" placeholder="2272001"
            ...
            <div>
              ...
              <div x-data="{ showPassword: false }" class="relative">
                ...
                <span @click="showPassword = !showPassword"
                  class="absolute inset-y-3 z-30 text-gray-500 -translate-y-1/2 cursor-pointer right-4 top-1/2 dark:text-gray-400">
