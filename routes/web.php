...
Route::get('/first-login', [MahasiswaController::class, 'firstTimeLogin'])->name('mahasiswa.first-login');
Route::post('/first-login', [MahasiswaController::class, 'storeFirstTimeLogin'])->name('mahasiswa.first-login.store');

// Login Pertama kali User
Route::get('/user/first-login', [UserController::class, 'firstTimeLogin'])->name('user.first-login');
Route::post('/user/first-login', [UserController::class, 'storeFirstTimeLogin'])->name('user.first-login.store');



// Profile
Route::middleware(['auth:mahasiswa,web',])->group(function () {
    Route::get('/profile', [ProfileController::class, 'edit'])->name('profile.edit');
    Route::put('/profile', [ProfileController::class, 'update'])->name('profile.update');
    Route::delete('/profile', [ProfileController::class, 'destroy'])->name('profile.destroy');
     Route::get('/pengajuan/{pengajuan}/detial', [PengajuanController::class, 'detail'])->name('pengajuan.detail');
    Route::get('/pengajuan/{pengajuan}/download', [PengajuanController::class, 'download'])->name('pengajuan.download');
...
Route::get('/surat/verify/{pengajuan}', [SuratController::class, 'verify'])->name('surat.verify');
...
Route::middleware(['auth', 'role:1'])->group(function () {
    ...
    // Pengajuan
    Route::get('/pengajuan/proses/pengajuan', [PengajuanController::class, 'prosesPengajuan'])->name('pengajuan.proses.pengajuan');
    Route::get('/pengajuan/history/pengajuan', [PengajuanController::class, 'historyPengajuanStaff'])->name('pengajuan.history.pengajuan');
    Route::get('/pengajuan/{pengajuan}/proses', [PengajuanController::class, 'prosesDetail'])->name('pengajuan.proses.detail');
    ...
    Route::get('/pengajuan/{pengajuan}/preview-final', [PengajuanController::class, 'previewFinal'])->name('pengajuan.preview.final');

    Route::post('/pengajuan/{pengajuan}/lhsm/accept', [PengajuanController::class, 'acceptLhsm'])->name('pengajuan.accept.lhsm');
    Route::post('/pengajuan/{pengajuan}/lhsm/preview', [PengajuanController::class, 'previewLhsm'])->name('pengajuan.lhsm.preview');
